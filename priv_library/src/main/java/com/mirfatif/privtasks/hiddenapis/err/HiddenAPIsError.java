...
/*
 Wrapper to send consistent Errors to calling PrivTasks class from different implementations
 of HiddenAPIs.
 It wraps any Exceptions or Errors thrown due to methods being hidden which include
 IllegalAccessException, NoSuchFieldException, NoSuchFieldError, NoSuchMethodException and
 NoSuchMethodError.
